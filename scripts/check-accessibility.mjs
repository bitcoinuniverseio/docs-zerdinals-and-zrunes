...
const ALL_ROUTES = [
  ...
  '/protocols/shielded-bitcoin/',
  '/protocols/names-and-registries/',
  '/protocols/provenance-studio/',
  '/protocols/rights-and-remix/',
  '/protocols/passes-and-events/',
  '/protocols/private-releases/',
